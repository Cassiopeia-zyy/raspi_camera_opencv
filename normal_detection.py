...
file = "E:/opencv+py/photo_save"  # 保存位置

mkdir(file)

print("文件储存于E:/opencv+py/photo_save")
...
msg = easygui.msgbox(msg="移动物体保存于E:/opencv+py/photo_save")
...
while True:
    ...
    for c in cnts:
        ...
        text = "Find Target! save as E:/opencv+py/photo_save"
    ...
    if flat == 1:  # 设置一个标签，当有运动的时候为1
        ...
        fn = 'E:/opencv+py/photo_save\shot%d.jpg' % (shot_idx)
